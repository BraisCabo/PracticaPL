...
public class PracticaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LBRACE", "RBRACE", "DEFINE", "SEMICOLON", "INTEGER", "FLOAT", "STRING", 
			"VOID", "STRUCT", "COMMA", "MAIN", "LPARENTHESIS", "RPARENTHESIS", "IF", 
			"ELSE", "WHILE", "DO", "FOR", "AND", "OR", "NOT", "SMORE", "SLESS", "SMOREE", 
			"SLESSE", "SEQUAL", "SASIGN", "PLUS", "LESS", "TIMES", "DIV", "MOD", 
			"CONST_DEF_IDENTIFIER", "IDENTIFIER", "NUMERIC_INTEGER_CONST", "NUMERIC_REAL_CONST", 
			"MIXED_REAL", "FIXED_POINT", "INITIAL_POINT", "EXPONENTIAL", "STRING_CONST", 
			"DOUBLE", "SIMPLE", "COMMENT", "ONE_LINE", "IGNORE", "MULTIPLE_LINE", 
			"DIGIT"
		};
	}
